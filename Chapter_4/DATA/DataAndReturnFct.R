...
Oil = Quandl('OPEC/ORB' , start_date= "2007-12-31", end_date = "2018-09-28")
Gold = Quandl('WGC/GOLD_DAILY_USD', start_date= "2007-12-31" , end_date = "2018-09-28")
SP500 = read.csv("^GSPC.csv", stringsAsFactors=FALSE) %>% .[,c(1,5)] 
oos <- read.csv("^GSPC_OOS.csv", stringsAsFactors=FALSE) %>% .[,c(1,5)] 
SP500 <- rbind(SP500,oos)
