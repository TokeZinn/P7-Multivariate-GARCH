...
BENCH_BEKK_2006 = Conditional_WLR(OS,densities_BENCH,densities_BEKK,levels,debug = F)
BENCH_DCC_2006 = Conditional_WLR(OS,densities_BENCH,densities_DCC,levels,debug = F)
BENCH_uGARCH_2006 = Conditional_WLR(OS,densities_BENCH,densities_g,levels,debug = F)
BEKK_DCC_2006 = Conditional_WLR(OS,densities_BEKK,densities_DCC,levels,debug = F)
BEKK_uGARCH_2006 = Conditional_WLR(OS,densities_BEKK,densities_g,levels,debug = F)
DCC_uGARCH_2006 = Conditional_WLR(OS,densities_DCC,densities_g,levels,debug = F)