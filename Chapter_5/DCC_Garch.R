...
save(H_g,file = "./Forecasts_2006/uGARCH_forecasts_2006.Rdata")

save(H_dcc,file = "./Forecasts_2006/DCC_forecasts_2006.Rdata")
stopCluster(cl)
...
save(H_g,file = "./Forecasts_2012/uGARCH_forecasts_2012.Rdata")

save(H_dcc,file = "./Forecasts_2012/DCC_forecasts_2012.Rdata")
stopCluster(cl)
